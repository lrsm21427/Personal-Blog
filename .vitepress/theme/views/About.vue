  ...
  <div class="about">
    ...
    <div class="about-content" style="grid-template-columns: 3fr 2fr">
      ...
      <div class="about-item hello">
        ...
        <span class="text2 title2">我是刘瑞</span>
        <span class="text3">是一名前端开发工程师、渴望全栈</span>
      </div>
      <!-- 追求 -->
...
<!--        />-->
    ...
    <div class="about-content" style="grid-template-columns: 3fr 2fr">
      ...
      <div class="about-item character" style="--color: #4298b4">
        ...
        <span class="title2">主人公</span>
        <span class="title2" style="color: var(--color)">ENFJ-T</span>
        <span class="more">
          在
          <a href="https://www.16personalities.com/ch/" target="_blank">16personalities</a>
          了解更多关于
          <a href="https://www.16personalities.com/ch/enfj-%E4%BA%BA%E6%A0%BC" target="_blank">
            主人公
          </a>
        </span>
        <img
      ...
      <div class="about-item">
        ...
        <span class="title1" style="margin-top: 20px">一半疯了，</span>
        <span class="title2">一半算了。</span>
      </div>
    </div>
    ...
    <div class="about-content" style="grid-template-columns: 2fr 3fr">
      ...
      <div class="about-item child">
        ...
        <div class="about-item info">
          ...
          <div class="info-item">
            <span class="info-name">正在求职</span>
    ...
    <div class="about-content" style="display: flex">
      <div class="about-item">
        ...
        <p class="text">
          建这个站的时候，是为了能够有一个自己能够<strong>积累知识</strong>和<strong>兴趣</strong>的地方。和他人分享知识和经验，如果能够帮助到更多的人，帮助更多人解决问题，那一定是非常棒的事情。
        </p>
        <p class="text">
          这里大多都是<strong>技术向</strong>的文章，也是对自己的成长的记录，如果在下的某篇文章能够帮助到你，那我也是很开心的。
        </p>
        <p class="text">
          这些就是创造这个小站的本意，<strong>也是用于分享生活</strong>。有幸能和你相遇在这里，相信我们能共同留下一段美好记忆。
        </p>
      </div>
    </div>
  </div>
